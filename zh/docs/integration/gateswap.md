...
1. 打开<a href="https://www.hipo.com/zh/" target="_blank">Hipo官网</a>，点击“流动池”模块；
	...
	<img src="../../images/liquidity0.png"  height=70% width=70%>

2. 进入“流动池”模块，如果您的钱包网络不是GateChain，请切换钱包网络至GateChain；

	<img src="../../images/liquidity1.png"  height=70% width=70%>

3. 在流动池页面，点击“添加流动性”，选择列表中的token或输入erc20合约地址，添加流动性；
	
	<img src="../../images/liquidity2.png"  height=70% width=70%>
...
7. 流动池页面，我的流动池模块显示账户已添加池子的信息，可以操作“继续添加”、“提取”。
	...
	<img src="../../images/liquidity3.png"  height=70% width=70%>
...
1. 添加流动性成功后，在“我的流动池”模块，点击“提取”；
	...
	<img src="../../images/liquidity4.png"  height=70% width=70%>
...
4. 授权成功后，点击“提取”，跳转到钱包确认提取；
	...
	<img src="../../images/liquidity5.png"  height=70% width=70%>
