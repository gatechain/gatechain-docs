...
??? note "返回示例:"
	...
	**Important** write this mnemonic phrase in a safe place.
	...
	flee agree charge truth answer flush inflict shove nice valid auto love laugh review frame sword later man inside couch slogan level guitar diet //账户助记词，只出现在创建账户时，之后使用show、list都不会显示，建议保存
	```
...
??? note "返回示例:"
	...
	```bash
	Key "gt11efwuug5y8ccvz54uunhdet22wpdf5huva7720v47ffej2vv0cy4863gc945j9d22n3n9v0" saved to disk. //多签账户地址，使用gatecli account list查询该地址公钥等信息，使用gatecli account publish-multisig公布多签账户后，得到gt2开头的多签账户地址
	```
...
### <span id="查询账户信息">查询账户信息 [API](../api/account.md#查询账户信息)</span>
```bash
...
### <span id="查询账户余额">查询账户余额 [API](../api/account.md#查询账户余额)</span>
```bash
...
### <span id="公布多签账户">公布多签账户 [API](../api/account.md#公布多签账户)</span>
```bash
