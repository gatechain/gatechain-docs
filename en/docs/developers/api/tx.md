...
### <span id="Send-Transaction">Send Transaction [command line](../cli/tx.md#Send-Transaction)</span>
...
### <span id="Query-a-Single-Transaction">Query a Single Transaction [command line](../cli/tx.md#Query-a-Single-Transaction)</span>
