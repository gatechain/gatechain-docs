...
### <span id="Create-a-Vault-Account">Create a Vault Account [API](../api/vault-account.md#Create-a-Vault-Account)</span>
...
### <span id="Change-Clearing-Height">Change Clearing Height [API](../api/vault-account.md#Change-Clearing-Height)</span>
...
### <span id="Clear-Account-Transaction">Clear Account Transaction [API](../api/vault-account.md#Clear-Account-Transaction)</span>
```bash
...
### <span id="Query-Vault-Account-Information">Query Vault Account Information [API](../api/vault-account.md#Query-Vault-Account-Information)</span>
```bash
