...
### <span id="Query-Account-Information">Query Account Information [API](../api/account.md#Query-Account-Information)</span>
```bash
...
### <span id="Query-Account-Balance">Query Account Balance [API](../api/account.md#Query-Account-Balance)</span>
...
### <span id="Publish-Multisignature-Account">Publish Multisignature Account [API](../api/account.md#Publish-Multisignature-Account)</span> 
