...
>  本文档涉及的版本为测试版，后继开发工作在持续进行，测试阶段可能出现多次网络重置操作
>  测试币可能在重置中清空，再次获取新的测试币即可。
...
- 1 ）进入区块链浏览器监控页面
	...
	- 或者直接访问[测试网区块浏览器](https://explorer.gatechain.io/monitor) 点击“监控”进入账户监控设置页面。 <br/>![](./images/monitor0.png)</br>
