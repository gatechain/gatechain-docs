...
### 查询委托账户在单个共识账户的委托收益 [API](../API/distribution.md#查询委托账户在单个共识账户的委托收益-命令行)
```bash
...
### 查询委托账户在所有共识账户的委托收益 [API](../API/distribution.md#查询委托账户在所有共识账户的委托收益-命令行)
```bash
...
### 查询共识账户仍未支付的委托收益 [API](../API/distribution.md#查询共识账户仍未支付的委托收益-命令行)
...
### 查询共识账户的收益 [API](../API/distribution.md#查询共识账户的收益-命令行)
...
### 查询分配和基金会参数 [API](../API/distribution.md#查询分配和基金会参数-命令行)
