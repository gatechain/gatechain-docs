...
### <span id="Query-Account-Information">Query Account Information [API](../../api/account/index.md#query-account-information-command-line)</span>
```bash
...
### <span id="Query-Account-Balance">Query Account Balance [API](../../api/account/index.md#query-account-balance-command-line)</span>
...
### <span id="Publish-Multisignature-Account">Publish Multisignature Account [API](../../api/account/index.md#publish-multisignature-account-command-line)</span> 
