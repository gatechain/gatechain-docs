...
::: details Return example:
	  ...
	  //transaction  hash，using gatecli tx show {hash} to query detailed information of this transaction 
...
### <span id="Query-Consensus-Account-List">Query Consensus Account List [API](../../api/con-account/index.md#query-consensus-account-list-command-line)</span>
