...
### <span id="Delegate-Token-To-Consensus-Account">Delegate Token To Consensus Account [API](../../api/staking/index.md#delegate-token-to-consensus-account-command-line)</span>
...
### <span id="Query-Delegation-Information-of-A-Delegator-Account-In-A-Consensus-Account">Query Delegation Information of A Delegator Account In A Consensus Account [API](../../api/staking/index.md#query-delegation-information-of-A-delegator-account-in-a-consensus-account-command-line)</span>
...
### <span id="Query-Delegation-Information-of-A-Delegator-Account-In-All-Consensus-Accounts">Query Delegation Information of A Delegator Account In All Consensus Accounts [API](../../api/staking/index.md#query-delegation-information-of-a-delegator-account-in-all-consensus-accounts-command-line)</span>
...
### <span id="Shift-Delegation">Shift Delegation [API](../../api/staking/index.md#shift-delegation-command-line)</span>
...
### <span id="Query-All-Delegation-Shifts-of-A-Specific-Delegator-Account">Query All Delegation Shifts  of A Specific Delegator Account [API](../../api/staking/index.md#query-delegation-shifts-command-line)</span>
...
### <span id="Undelegate-From-A-Consensus-Account">Undelegate From A Consensus Account [API](../../api/staking/index.md#undelegate-from-a-consensus-account-command-line)</span>
...
### <span id="Release-of-delegation-through-security-account">Release of delegation through security account [API](../../api/staking/index.md#release-of-delegation-through-security-account-command-line)</span>
...
### <span id="Query-Undelegations-of-A-Delegator-Account-in-A-consensus-Account">Query Undelegations of A Delegator Account in A consensus Account [API](../../api/staking/index.md#query-undelegations-of-a-delegator-account-in-a-consensus-account-command-line)</span>
...
### <span id="Query-Undelegations-of-A-Delegator-Account-in-All-consensus-Account">Query Undelegations of A Delegator Account in All consensus Accounts [API](../../api/staking/index.md#query-undelegations-of-a-delegator-account-in-all-consensus-account-command-line)</span>
...
### <span id="Query-All-Delegations-Of-A-Specific-Consensus-Account">Query All Delegations Of A Specific Consensus Account [API](../../api/staking/index.md#query-all-delegations-of-a-specific-consensus-account-command-line)</span>
...
### <span id="Query-All-Delegation-Shifts-For-A-Specific-Consensus-Account">Query All Delegation Shifts For A Specific Consensus Account [API](../../api/staking/index.md#query-delegation-shifts-command-line)</span>
...
### <span id="Query-All-Undelegations-Of-A-Specific-Consensus-Account">Query All Undelegations Of A Specific Consensus Account [API](../../api/staking/index.md#query-qll-undelegations-of-A-specific-consensus-account-command-line)</span>
...
### <span id="Query-Staking-Pool">Query Staking Pool [API](../../api/staking/index.md#query-staking-Pool-command-line)</span>
...
### <span id="Query-Staking-Parameters">Query Staking Parameters [API](../../api/staking/index.md#query-staking-parameters-command-line)</span>
