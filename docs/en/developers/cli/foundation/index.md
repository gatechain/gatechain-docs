...
::: details Foundation initial config file details:
	{
	    "members":[
	        {
...
### <span id="Query-Foundation-Member-List">Query Foundation Member List [API](../../api/foundation/index.md#query-foundation-member-list-command-line)</span>
