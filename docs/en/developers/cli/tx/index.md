...
### <span id="Send-Transaction">Send Transaction [API](../../api/tx/index.md#send-transaction-command-line)</span>
...
::: details Return example:
	  TxHash: IRREVOCABLEPAY-0FD8A17798EC2CC637252687CA7DACA39BE0C555496EC3242F90C7C0BBBFE5F10A34A51D866BEC91A9866275BED9B522 
...
###  <span id="Query-a-Single-Transaction">Query a Single Transaction [API](../../api/tx/index.md#query-a-single-transaction-command-line)</span>
```bash
