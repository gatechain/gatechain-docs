### <span id="Delegate-Token-To-Consensus-Account">Delegate Token To Consensus Account [command line](../../cli/staking/index.md#delegate-token-to-consensus-account-api)</span>
...
### <span id="Query-Delegation-Information-of-A-Delegator-Account-In-A-Consensus-Account">Query Delegation Information of A Delegator Account In A Consensus Account [command line](../../cli/staking/index.md#query-delegation-information-of-a-delegator-account-in-a-consensus-account-api)</span>
...
### <span id="Query-Delegation-Information-of-A-Delegator-Account-In-All-Consensus-Accounts">Query Delegation Information of A Delegator Account In All Consensus Accounts [command line](../../cli/staking/index.md#query-delegation-information-of-a-delegator-account-in-all-consensus-accounts-api)</span>
...
### <span id="Shift-Delegation">Shift Delegation [command line](../../cli/staking/index.md#shift-delegation-api)</span>
...
### <span id="Query-Delegation-Shifts">Query Delegation Shifts [command line](../../cli/staking/index.md#query-all-delegation-shifts-of-a-specific-delegator-account-api)</span>
...
### <span id="Undelegate-From-A-Consensus-Account">Undelegate From A Consensus Account [command line](../../cli/staking/index.md#undelegate-from-a-consensus-account-api)</span>
...
### <span id="Release-of-delegation-through-security-account">Release of delegation through security account [command line](../../cli/staking/index.md#release-of-delegation-through-security-account-api)</span>
...
### <span id="Query-Undelegations-of-A-Delegator-Account-in-A-consensus-Account">Query Undelegations of A Delegator Account in A consensus Account [command line](../../cli/staking/index.md#query-undelegations-of-a-delegator-account-in-a-consensus-account-api)</span>
...
### <span id="Query-Undelegations-of-A-Delegator-Account-in-All-consensus-Account">Query Undelegations of A Delegator Account in All consensus Accounts [command line](../../cli/staking/index.md#query-undelegations-of-a-delegator-account-in-all-consensus-account-api)</span>
...
### <span id="Query-All-Delegations-Of-A-Specific-Consensus-Account">Query All Delegations Of A Specific Consensus Account [command line](../../cli/staking/index.md#query-all-delegations-of-a-specific-consensus-account-api)</span>
...
### <span id="Query-All-Undelegations-Of-A-Specific-Consensus-Account">Query All Undelegations Of A Specific Consensus Account [command line](../../cli/staking/index.md#query-all-undelegations-of-a-specific-consensus-account-api)</span>
...
### <span id="Query-Staking-Pool">Query Staking Pool [command line](../../cli/staking/index.md#query-staking-pool-api)</span>
...
### <span id="Query-Staking-Parameters">Query Staking Parameters [command line](../../cli/staking/index.md#query-staking-parameters-api)</span>
