...
### <span id="设置提取委托收益的账户">设置提取委托收益的账户 [API](../../api/distribution/index.md#设置提取委托收益的账户-命令行)</span>
...
### <span id="委托账户从单个共识账户提取部分收益">委托账户从单个共识账户提取部分收益 [API](../../api/distribution/index.md#委托账户从单个共识账户提取部分收益-命令行)</span>
```bash
...
### <span id="委托账户从共识账户提取全部收益">委托账户从共识账户提取全部收益 [API](../../api/distribution/index.md#委托账户从共识账户提取全部收益-命令行)</span>
```bash
...
### <span id="查询委托账户在所有共识账户的委托收益">查询委托账户在所有共识账户的委托收益 [API](../../api/distribution/index.md#查询委托账户在所有共识账户的委托收益-命令行)</span>
```bash
...
### <span id="查询共识账户仍未支付的委托收益">查询共识账户仍未支付的委托收益 [API](../../api/distribution/index.md#查询共识账户仍未支付的委托收益-命令行)</span>
...
### <span id="查询共识账户的收益">查询共识账户的收益 [API](../../api/distribution/index.md#查询共识账户的收益-命令行)</span>
...
### <span id="查询分配和基金会参数">查询分配和基金会参数 [API](../../api/distribution/index.md#查询分配和基金会参数-命令行)</span>
