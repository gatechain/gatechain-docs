...
### <span id="委托代币到共识账户">委托代币到共识账户 [API](../../api/staking/index.md#委托代币到共识账户-命令行)</span>
...
### <span id="查询委托账户在单个共识账户的委托信息">查询委托账户在单个共识账户的委托信息 [API](../../api/staking/index.md#查询委托账户在单个共识账户的委托信息-命令行)</span>
```bash
...
### <span id="查询委托账户在所有共识账户的委托信息">查询委托账户在所有共识账户的委托信息 [API](../../api/staking/index.md#查询委托账户在所有共识账户的委托信息-命令行)</span>
...
### <span id="转移委托">转移委托 [API](../../api/staking/index.md#转移委托-命令行)</span>
...
### <span id="查询指定委托账户所有的转移委托记录">查询指定委托账户所有的转移委托记录 [API](../../api/staking/index.md#查询转移委托记录-命令行)</span>
...
### <span id="从共识账户解绑">从共识账户解绑 [API](../../api/staking/index.md#从共识账户解绑-命令行)</span>
...
### <span id="代理解除委托">代理解除委托 [API](../../api/staking/index.md#代理解除委托-命令行)</span>
...
### <span id="查询委托账户在单个共识账户已解除的委托记录">查询委托账户在单个共识账户已解除的委托记录 [API](../../api/staking/index.md#查询委托账户在单个共识账户已解除的委托记录-命令行)</span>
...
### <span id="查询委托账户在所有共识账户已经解除的委托记录">查询委托账户在所有共识账户已经解除的委托记录 [API](../../api/staking/index.md#查询委托账户在所有共识账户已经解除的委托记录-命令行)</span>
...
### <span id="查询指定共识账户所有的委托">查询指定共识账户所有的委托 [API](../../api/staking/index.md#查询指定共识账户所有的委托-命令行)</span>
...
### <span id="查询指定共识账户所有转移委托的记录">查询指定共识账户所有转移委托的记录 [API](../../api/staking/index.md#查询转移委托记录-命令行)</span>
...
### <span id="查询指定共识账户所有已解除的委托">查询指定共识账户所有已解除的委托 [API](../../api/staking/index.md#查询指定共识账户所有已解除的委托-命令行)</span>
...
### <span id="查询权益质押池的信息">查询权益质押池的信息 [API](../../api/staking/index.md#查询权益质押池的信息-命令行)</span>
...
### <span id="查询权益质押的参数">查询权益质押的参数 [API](../../api/staking/index.md#查询权益质押的参数-命令行)</span>
